export default class ListModel {
	...
	caastrarBanco() {
		let obj = [
			...
			// { item: "Abridor de garrafa e de latas", qtde: "1", name: "", tel: "" },
			// { item: "Peneiras(P, M e G)", qtde: "1", name: "", tel: "" },
			// { item: "Descansos de panela", qtde: "1", name: "", tel: "" },
			// { item: "Pilão", qtde: "1", name: "", tel: "" },
			// { item: "Luva térmica", qtde: "1", name: "", tel: "" },
			// { item: "Ralador", qtde: "1", name: "", tel: "" },
			// { item: "Saladeira", qtde: "1", name: "", tel: "" },
			// { item: "Panos de chão", qtde: "1", name: "", tel: "" },
			// { item: "Garrafa térmica", qtde: "1", name: "", tel: "" }
			// { item: "Cabide", qtde: "1", name: "", tel: "" },
			// { item: "Jogo de panos de prato x2", qtde: "1", name: "", tel: "" },
			// { item: "lençol elástico de cama queen", qtde: "1", name: "", tel: "" },
			// { item: "lençol elástico de cama queen", qtde: "1", name: "", tel: "" }
			{ item: "Jogo de panos de prato", qtde: "1", name: "", tel: "" }
		];
		obj.forEach((value) => {
